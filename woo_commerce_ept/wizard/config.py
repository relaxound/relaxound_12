...
class woo_config_settings(models.TransientModel):
    ...
    order_update_next_execution = fields.Datetime('ext execution', help='Next execution time')    
    ...
    update_stock_user_id = fields.Many2one('res.users',string="usar",help='User',default=lambda self: self.env.user)
