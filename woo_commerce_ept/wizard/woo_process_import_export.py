...
class woo_process_import_export(models.TransientModel):
    ...
    _description='woo.process.import.export'   
    ...
    def create_categ_in_woo(self,categ_id,instance,ctg_list = []):
        ...
        if categ_id:
            ...
            for categ_id in list(set(reversed(ctg_list))):
                ...
                if not woo_product_category:
                    if not categ_id.parent_id:
                        ...
                        parent_id = woo_product_categ.search([('name','=',categ_id.parent_id.name)],limit=1)
                    ...
                    if not parent_id.parent_id.id==woo_product_category.id:
