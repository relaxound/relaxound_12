...
class woo_instance_ept(models.Model):
    ...
    published_product_ids = fields.One2many('woo.product.template.ept','woo_instance_id',domain=[('website_published','=',True)],string="publish")
    ...
    product_ids = fields.One2many('woo.product.template.ept','woo_instance_id',string="Product")
