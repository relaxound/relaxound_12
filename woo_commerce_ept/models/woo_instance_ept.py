...
class woo_instance_ept(models.Model):
    ...
    published_product_ids = fields.One2many('woo.product.template.ept','woo_instance_id',domain=[('website_published','=',True)],string="Published2")
    published_product_count = fields.Integer(compute='_count_all', string="published")
    
    unpublished_product_ids = fields.One2many('woo.product.template.ept','woo_instance_id',domain=[('website_published','=',False),('exported_in_woo','=',True)],string="Published1")
    ...
    assigned_picking_count =fields.Integer(compute='_count_all', string="Assigned Picking")
    ...
    product_count = fields.Integer(compute='_count_all', string="Product2")
    
    sale_order_ids = fields.One2many('sale.order','woo_instance_id',string="Orders")
    sale_order_count = fields.Integer(compute='_count_all', string="Product1")
