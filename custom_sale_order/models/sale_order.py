	...
	def custom_tax(self):
		if self.order_line:
			if self.partner_id.country_id or self.partner_id.property_account_position_id.name:
				...
				elif self.partner_id.country_id and self.partner_id.property_account_position_id.name and self.partner_id.vat: 
					if self.partner_id.country_id.name!='Germany' and 'EU' in self.partner_id.property_account_position_id.name and self.partner_id.vat:
