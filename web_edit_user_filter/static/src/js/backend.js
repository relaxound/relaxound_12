...
//                                {
//                                    self.$('.o-edit-user-filter').click(function(event){
//                                    window.open("/web?debug#id="+ filter.id +"&action=12&model=ir.filters&view_type=form&menu_id=4",'_self','', true);
//                                    })
...
//                            myu = document.getElementById('fltr_id').value;
                            self.$('.o-edit-user-filter').click(function(event){
                            window.open("/web?debug#id="+ filter.id +"&action=12&model=ir.filters&view_type=form&menu_id=4",'_self','', true);
                            })
